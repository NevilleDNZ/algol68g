...
#define ERROR_INVALID_SEQUENCE "Y is an invalid A"
...
#define ERROR_SOURCE_FILE_INCLUDE_OPEN "error opening include file"
#define ERROR_SOURCE_FILE_OPEN "error opening source file"
