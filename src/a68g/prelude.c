...
void a68_id2 (BOOL_T portable, char *n1, char *n2, MOID_T * m, GPROC * q)
{
  add_a68_standenv (portable, IDENTIFIER, some_node (TEXT (add_token (&A68 (top_token), n1))), NO_TEXT, m, 0, q);
  add_a68_standenv (A68_EXT, IDENTIFIER, some_node (TEXT (add_token (&A68 (top_token), n2))), NO_TEXT, m, 0, q);
}
...
// Identifiers.
  ...
  a68_id2 (A68_STD, "longlongpi", "qpi", M_LONG_LONG_REAL, genie_pi_mp);
...
// Machine environ parameters.
  a68_idf (A68_EXT, "i32mach", A68_MCACHE (proc_int_int), genie_i32mach);
  a68_idf (A68_EXT, "r64mach", A68_MCACHE (proc_int_real), genie_i32mach);
#if (A68_LEVEL >= 3)
  m = a68_proc (M_LONG_INT, M_INT, NO_MOID);
  a68_idf (A68_EXT, "i64mach", m, genie_i64mach);
  m = a68_proc (M_LONG_REAL, M_INT, NO_MOID);
  a68_idf (A68_EXT, "r128mach", m, genie_r128mach);
#endif
// BITS procedures.
...
// Procedures
  m = A68_MCACHE (proc_real_real);
  a68_id2 (A68_EXT, "arccosdg", "acosdg", m, genie_acosdg_real);
  a68_id2 (A68_EXT, "arccosh", "acosh", m, genie_acosh_real);
  a68_id2 (A68_EXT, "arccot", "acot", m, genie_acot_real);
  a68_id2 (A68_EXT, "arccotdg", "acotdg", m, genie_acotdg_real);
  a68_id2 (A68_EXT, "arccsc", "acsc", m, genie_acsc_real);
  a68_id2 (A68_EXT, "arccscdg", "acscdg", m, genie_acscdg_real);
  a68_id2 (A68_EXT, "arcsec", "asec", m, genie_asec_real);
  a68_id2 (A68_EXT, "arcsecdg", "asecdg", m, genie_asecdg_real);
  a68_id2 (A68_EXT, "arcsindg", "asindg", m, genie_asindg_real);
  a68_id2 (A68_EXT, "arcsinh", "asinh", m, genie_asinh_real);
  a68_id2 (A68_EXT, "arctandg", "atandg", m, genie_atandg_real);
  a68_id2 (A68_EXT, "arctanh", "atanh", m, genie_atanh_real);
  a68_id2 (A68_STD, "arccos", "acos", m, genie_acos_real);
  a68_id2 (A68_STD, "arcsin", "asin", m, genie_asin_real);
  a68_id2 (A68_STD, "arctan", "atan", m, genie_atan_real);
  a68_idf (A68_EXT, "cas", m, genie_cas_real);
  ...
  a68_idf (A68_EXT, "cscdg", m, genie_cscdg_real);
  ...
  a68_idf (A68_EXT, "secdg", m, genie_secdg_real);
...
// Miscellaneous.
  a68_id2 (A68_EXT, "arctan2", "atan2", A68_MCACHE (proc_real_real_real), genie_atan2_real);
  a68_id2 (A68_EXT, "arctan2dg", "atan2dg", A68_MCACHE (proc_real_real_real), genie_atan2dg_real);
...
//
  ...
  a68_id2 (A68_EXT, "complexarcsinh", "casinh", m, genie_asinh_complex);
  a68_id2 (A68_EXT, "complexarcsin", "casin", m, genie_asin_complex);
  a68_id2 (A68_EXT, "complexarctanh", "catanh", m, genie_atanh_complex);
  a68_id2 (A68_EXT, "complexarctan", "catan", m, genie_atan_complex);
  a68_id2 (A68_EXT, "complexcosh", "ccosh", m, genie_cosh_complex);
  a68_id2 (A68_EXT, "complexcos", "ccos", m, genie_cos_complex);
  a68_id2 (A68_EXT, "complexexp", "cexp", m, genie_exp_complex);
  a68_id2 (A68_EXT, "complexln", "cln", m, genie_ln_complex);
  a68_id2 (A68_EXT, "complexsinh", "csinh", m, genie_sinh_complex);
  a68_id2 (A68_EXT, "complexsin", "csin", m, genie_sin_complex);
  a68_id2 (A68_EXT, "complexsqrt", "csqrt", m, genie_sqrt_complex);
  a68_id2 (A68_EXT, "complextanh", "ctanh", m, genie_tanh_complex);
  a68_id2 (A68_EXT, "complextan", "ctan", m, genie_tan_complex);
// BOOL ops.
...
//
  ...
  a68_id2 (A68_EXT, "longlongarccotdg", "qacotdg", m, genie_acotdg_mp);
  a68_id2 (A68_EXT, "longlongarccot", "qacot", m, genie_acot_mp);
  a68_id2 (A68_EXT, "longlongarccscdg", "qacscdg", m, genie_acscdg_mp);
  a68_id2 (A68_EXT, "longlongarccsc", "qacsc", m, genie_acsc_mp);
  a68_id2 (A68_EXT, "longlongarcsecdg", "qasecdg", m, genie_asecdg_mp);
  a68_id2 (A68_EXT, "longlongarcsec", "qasec", m, genie_asec_mp);
  a68_id2 (A68_EXT, "longlongarcsindg", "qasindg", m, genie_asindg_mp);
  a68_id2 (A68_EXT, "longlongarcsinh", "qasinh", m, genie_asinh_mp);
  a68_id2 (A68_EXT, "longlongarctandg", "qatandg", m, genie_atandg_mp);
  a68_id2 (A68_EXT, "longlongarctanh", "qatanh", m, genie_atanh_mp);
  a68_id2 (A68_EXT, "longlongcas", "qcas", m, genie_cas_mp);
  a68_id2 (A68_EXT, "longlongcbrt", "qcbrt", m, genie_curt_mp);
  a68_id2 (A68_EXT, "longlongcosdg", "qcosdg", m, genie_cosdg_mp);
  a68_id2 (A68_EXT, "longlongcosh", "qcosh", m, genie_cosh_mp);
  a68_id2 (A68_EXT, "longlongcospi", "qcospi", m, genie_cospi_mp);
  a68_id2 (A68_EXT, "longlongcotdg", "qcotdg", m, genie_cotdg_mp);
  a68_id2 (A68_EXT, "longlongcotpi", "qcotpi", m, genie_cotpi_mp);
  a68_id2 (A68_EXT, "longlongcot", "qcot", m, genie_cot_mp);
  a68_id2 (A68_EXT, "longlongcscdg", "qcscdg", m, genie_cscdg_mp);
  a68_id2 (A68_EXT, "longlongcsc", "qcsc", m, genie_csc_mp);
  a68_id2 (A68_EXT, "longlongcurt", "qcurt", m, genie_curt_mp);
  a68_id2 (A68_EXT, "longlongerfc", "qerfc", m, genie_erfc_mp);
  a68_id2 (A68_EXT, "longlongerf", "qerf", m, genie_erf_mp);
  a68_id2 (A68_EXT, "longlonggamma", "qgamma", m, genie_gamma_mp);
  a68_id2 (A68_EXT, "longlonginverfc", "qinverfc", m, genie_inverfc_mp);
  a68_id2 (A68_EXT, "longlonginverf", "qinverf", m, genie_inverf_mp);
  a68_id2 (A68_EXT, "longlonglngamma", "qlngamma", m, genie_lngamma_mp);
  a68_id2 (A68_EXT, "longlongsecdg", "qsecdg", m, genie_secdg_mp);
  a68_id2 (A68_EXT, "longlongsec", "qsec", m, genie_sec_mp);
  a68_id2 (A68_EXT, "longlongsindg", "qsindg", m, genie_sindg_mp);
  a68_id2 (A68_EXT, "longlongsinh", "qsinh", m, genie_sinh_mp);
  a68_id2 (A68_EXT, "longlongsinpi", "qsinpi", m, genie_sinpi_mp);
  a68_id2 (A68_EXT, "longlongtandg", "qtandg", m, genie_tandg_mp);
  a68_id2 (A68_EXT, "longlongtanh", "qtanh", m, genie_tanh_mp);
  a68_id2 (A68_EXT, "longlongtanpi", "qtanpi", m, genie_tanpi_mp);
  a68_id2 (A68_STD, "longlongarccos", "qacos", m, genie_acos_mp);
  a68_id2 (A68_STD, "longlongarcsin", "qasin", m, genie_asin_mp);
  a68_id2 (A68_STD, "longlongarctan", "qatan", m, genie_atan_mp);
  a68_id2 (A68_STD, "longlongcos", "qcos", m, genie_cos_mp);
  a68_id2 (A68_STD, "longlongexp", "qexp", m, genie_exp_mp);
  a68_id2 (A68_STD, "longlongln", "qln", m, genie_ln_mp);
  a68_id2 (A68_STD, "longlonglog", "qlog", m, genie_log_mp);
...
//
  ...
  a68_id2 (A68_EXT, "longlongbeta", "qbeta", m, genie_beta_mp);
  a68_id2 (A68_EXT, "longlonggammaincf", "qgammaincf", m, genie_gamma_inc_f_mp);
...
//
  ...
  a68_id2 (A68_EXT, "longlongcomplexarcsinh", "qcasinh", m, genie_asinh_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexarcsin", "qcasin", m, genie_asin_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexarctanh", "qcatanh", m, genie_atanh_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexarctan", "qcatan", m, genie_atan_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexcosh", "qccosh", m, genie_cosh_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexcos", "qccos", m, genie_cos_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexexp", "qcexp", m, genie_exp_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexln", "qcln", m, genie_ln_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexsinh", "qcsinh", m, genie_sinh_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexsin", "qcsin", m, genie_sin_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplexsqrt", "qcsqrt", m, genie_sqrt_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplextanh", "qctanh", m, genie_tanh_mp_complex);
  a68_id2 (A68_EXT, "longlongcomplextan", "qctan", m, genie_tan_mp_complex);
// BYTES ops.
...
{
#if (A68_LEVEL <= 2)
  a68_id2 (A68_STD, "longpi", "dpi", M_LONG_REAL, genie_pi_mp);
...
//
  ...
  a68_id2 (A68_EXT, "longarccot", "dacot", m, genie_acot_mp);
  a68_id2 (A68_EXT, "longarccotdg", "dacotdg", m, genie_acosdg_mp);
  a68_id2 (A68_EXT, "longarccsc", "dacsc", m, genie_acsc_mp);
  a68_id2 (A68_EXT, "longarccscdg", "dacscdg", m, genie_acscdg_mp);
  a68_id2 (A68_EXT, "longarcsec", "dasec", m, genie_asec_mp);
  a68_id2 (A68_EXT, "longarcsecdg", "dasecdg", m, genie_asecdg_mp);
  a68_id2 (A68_EXT, "longarcsindg", "dasindg", m, genie_asindg_mp);
  a68_id2 (A68_EXT, "longarcsinh", "dasinh", m, genie_asinh_mp);
  a68_id2 (A68_EXT, "longarctandg", "datandg", m, genie_atandg_mp);
  a68_id2 (A68_EXT, "longarctanh", "datanh", m, genie_atanh_mp);
  a68_id2 (A68_EXT, "longcas", "dcas", m, genie_cas_mp);
  a68_id2 (A68_EXT, "longcbrt", "dcbrt", m, genie_curt_mp);
  a68_id2 (A68_EXT, "longcosdg", "dcosdg", m, genie_cosdg_mp);
  a68_id2 (A68_EXT, "longcosh", "dcosh", m, genie_cosh_mp);
  a68_id2 (A68_EXT, "longcospi", "dcospi", m, genie_cospi_mp);
  a68_id2 (A68_EXT, "longcot", "dcot", m, genie_cot_mp);
  a68_id2 (A68_EXT, "longcotdg", "dcotdg", m, genie_cotdg_mp);
  a68_id2 (A68_EXT, "longcotpi", "dcotpi", m, genie_cotpi_mp);
  a68_id2 (A68_EXT, "longcsc", "dcsc", m, genie_csc_mp);
  a68_id2 (A68_EXT, "longcscdg", "dcscdg", m, genie_cscdg_mp);
  a68_id2 (A68_EXT, "longcurt", "dcurt", m, genie_curt_mp);
  a68_id2 (A68_EXT, "longerfc", "derfc", m, genie_erfc_mp);
  a68_id2 (A68_EXT, "longerf", "derf", m, genie_erf_mp);
  a68_id2 (A68_EXT, "longgamma", "dgamma", m, genie_gamma_mp);
  a68_id2 (A68_EXT, "longinverfc", "dinverfc", m, genie_inverfc_mp);
  a68_id2 (A68_EXT, "longinverf", "dinverf", m, genie_inverf_mp);
  a68_id2 (A68_EXT, "longlngamma", "dlngamma", m, genie_lngamma_mp);
  a68_id2 (A68_EXT, "longsecdg", "dsecdg", m, genie_secdg_mp);
  a68_id2 (A68_EXT, "longsec", "dsec", m, genie_sec_mp);
  a68_id2 (A68_EXT, "longsindg", "dsindg", m, genie_sindg_mp);
  a68_id2 (A68_EXT, "longsinh", "dsinh", m, genie_sinh_mp);
  a68_id2 (A68_EXT, "longsinpi", "dsinpi", m, genie_sinpi_mp);
  a68_id2 (A68_EXT, "longtandg", "dtandg", m, genie_tandg_mp);
  a68_id2 (A68_EXT, "longtanh", "dtanh", m, genie_tanh_mp);
  a68_id2 (A68_EXT, "longtanpi", "dtanpi", m, genie_tanpi_mp);
// RR.
  a68_id2 (A68_STD, "longarccos", "dacos", m, genie_acos_mp);
  a68_id2 (A68_STD, "longarcsin", "dasin", m, genie_asin_mp);
  a68_id2 (A68_STD, "longarctan", "datan", m, genie_atan_mp);
  a68_id2 (A68_STD, "longcos", "dcos", m, genie_cos_mp);
  a68_id2 (A68_STD, "longexp", "dexp", m, genie_exp_mp);
  a68_id2 (A68_STD, "longln", "dln", m, genie_ln_mp);
  a68_id2 (A68_STD, "longlog", "dlog", m, genie_log_mp);
...
//
  ...
  a68_id2 (A68_EXT, "longbeta", "dbeta", m, genie_beta_mp);
  a68_id2 (A68_EXT, "longgammainc", "dgammainc", m, genie_gamma_inc_h_mp);
...
//
  ...
  a68_id2 (A68_EXT, "longcomplexarcsin", "dcasin", m, genie_asin_mp_complex);
  a68_id2 (A68_EXT, "longcomplexarcsinh", "dcasinh", m, genie_asinh_mp_complex);
  a68_id2 (A68_EXT, "longcomplexarctan", "dcatan", m, genie_atan_mp_complex);
  a68_id2 (A68_EXT, "longcomplexarctanh", "dcatanh", m, genie_atanh_mp_complex);
  a68_id2 (A68_EXT, "longcomplexcos", "dccos", m, genie_cos_mp_complex);
  a68_id2 (A68_EXT, "longcomplexcosh", "dccosh", m, genie_cosh_mp_complex);
  a68_id2 (A68_EXT, "longcomplexexp", "dcexp", m, genie_exp_mp_complex);
  a68_id2 (A68_EXT, "longcomplexln", "dcln", m, genie_ln_mp_complex);
  a68_id2 (A68_EXT, "longcomplexsin", "dcsin", m, genie_sin_mp_complex);
  a68_id2 (A68_EXT, "longcomplexsinh", "dcsin", m, genie_sinh_mp_complex);
  a68_id2 (A68_EXT, "longcomplexsqrt", "dcsqrt", m, genie_sqrt_mp_complex);
  a68_id2 (A68_EXT, "longcomplextan", "dctan", m, genie_tan_mp_complex);
  a68_id2 (A68_EXT, "longcomplextanh", "dctanh", m, genie_tanh_mp_complex);
...
{
#if (A68_LEVEL >= 3)
  a68_id2 (A68_STD, "longpi", "dpi", M_LONG_REAL, genie_pi_double);
...
//
  ...
  a68_id2 (A68_EXT, "longarccotdg", "dacotdg", m, genie_acotdg_double);
  a68_id2 (A68_EXT, "longarccot", "dacot", m, genie_acot_double);
  a68_id2 (A68_EXT, "longarccsc", "dacsc", m, genie_acsc_double);
  a68_id2 (A68_EXT, "longarccscdg", "dacscdg", m, genie_acscdg_double);
  a68_id2 (A68_EXT, "longarcsecdg", "dasecdg", m, genie_asecdg_double);
  a68_id2 (A68_EXT, "longarcsindg", "dasindg", m, genie_asindg_double);
  a68_id2 (A68_EXT, "longarcsinh", "dasinh", m, genie_asinh_double);
  a68_id2 (A68_EXT, "longarctandg", "datandg", m, genie_atandg_double);
  a68_id2 (A68_EXT, "longarctanh", "datanh", m, genie_atanh_double);
  a68_id2 (A68_EXT, "longcbrt", "dcbrt", m, genie_curt_double);
  a68_id2 (A68_EXT, "longcosdg", "dcosdg", m, genie_cosdg_double);
  a68_id2 (A68_EXT, "longcosh", "dcosh", m, genie_cosh_double);
  a68_id2 (A68_EXT, "longcospi", "dcospi", m, genie_cospi_double);
  a68_id2 (A68_EXT, "longcotdg", "dcotdg", m, genie_cotdg_double);
  a68_id2 (A68_EXT, "longcot", "dcot", m, genie_cot_double);
  a68_id2 (A68_EXT, "longcotpi", "dcotpi", m, genie_cotpi_double);
  a68_id2 (A68_EXT, "longcsc", "dcsc", m, genie_csc_double);
  a68_id2 (A68_EXT, "longcscdg", "dcscdg", m, genie_cscdg_double);
  a68_id2 (A68_EXT, "longcurt", "dcurt", m, genie_curt_double);
  a68_id2 (A68_EXT, "longerfc", "derfc", m, genie_erfc_double);
  a68_id2 (A68_EXT, "longerf", "derf", m, genie_erf_double);
  a68_id2 (A68_EXT, "longinverfc", "dinverfc", m, genie_inverfc_double);
  a68_id2 (A68_EXT, "longinverf", "dinverf", m, genie_inverf_double);
  a68_id2 (A68_EXT, "longgamma", "dgamma", m, genie_gamma_double);
  a68_id2 (A68_EXT, "longlngamma", "dlngamma", m, genie_lngamma_double);
  a68_id2 (A68_EXT, "longsec", "dsec", m, genie_sec_double);
  a68_id2 (A68_EXT, "longsecdg", "dsecdg", m, genie_secdg_double);
  a68_id2 (A68_EXT, "longsindg", "dsindg", m, genie_sindg_double);
  a68_id2 (A68_EXT, "longsinh", "dsinh", m, genie_sinh_double);
  a68_id2 (A68_EXT, "longsinpi", "dsinpi", m, genie_sinpi_double);
...
//
  ...
  a68_id2 (A68_EXT, "longcas", "dcas", m, genie_cas_double);
  a68_id2 (A68_STD, "longcos", "dcos", m, genie_cos_double);
  a68_id2 (A68_STD, "longexp", "dexp", m, genie_exp_double);
  a68_id2 (A68_STD, "longln", "dln", m, genie_ln_double);
  a68_id2 (A68_STD, "longlog", "dlog", m, genie_log_double);
...
//
  ...
  a68_id2 (A68_EXT, "longbeta", "dbeta", m, genie_beta_double);
  a68_id2 (A68_EXT, "longgammaincgf", "dgammaincgf", m, genie_gamma_inc_gf_double);
...
//
  ...
  a68_id2 (A68_EXT, "longcomplexarcsinh", "dcasinh", m, genie_asinh_double_compl);
  a68_id2 (A68_EXT, "longcomplexarcsin", "dcasin", m, genie_asin_double_compl);
  a68_id2 (A68_EXT, "longcomplexarctanh", "dcatanh", m, genie_atanh_double_compl);
  a68_id2 (A68_EXT, "longcomplexarctan", "dcatan", m, genie_atan_double_compl);
  a68_id2 (A68_EXT, "longcomplexatanh", "dcatanh", m, genie_atanh_double_compl);
  a68_id2 (A68_EXT, "longcomplexcosh", "dccosh", m, genie_cosh_double_compl);
  a68_id2 (A68_EXT, "longcomplexcos", "dccos", m, genie_cos_double_compl);
  a68_id2 (A68_EXT, "longcomplexexp", "dcexp", m, genie_exp_double_compl);
  a68_id2 (A68_EXT, "longcomplexln", "dcln", m, genie_ln_double_compl);
  a68_id2 (A68_EXT, "longcomplexsinh", "dcsinh", m, genie_sinh_double_compl);
  a68_id2 (A68_EXT, "longcomplexsin", "dcsin", m, genie_sin_double_compl);
  a68_id2 (A68_EXT, "longcomplexsqrt", "dcsqrt", m, genie_sqrt_double_compl);
  a68_id2 (A68_EXT, "longcomplextanh", "dctanh", m, genie_tanh_double_compl);
  a68_id2 (A68_EXT, "longcomplextan", "dctan", m, genie_tan_double_compl);
...
//
  ...
  a68_id2 (A68_EXT, "mpfrlonglonggamma", "mpfrqgamma", m, genie_gamma_mpfr);
  a68_id2 (A68_EXT, "mpfrlonglonginverfc", "mpfrqinverfc", m, genie_mpfr_inverfc_mp);
  a68_id2 (A68_EXT, "mpfrlonglonginverf", "mpfrqinverf", m, genie_mpfr_inverf_mp);
  a68_id2 (A68_EXT, "mpfrlonglonglngamma", "mpfrqlngamma", m, genie_lngamma_mpfr);
