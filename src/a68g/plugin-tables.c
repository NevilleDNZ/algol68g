...
TRANSLATION monadics_nocheck[] = {
  ...
  {genie_minus_complex, "a68_min_realus_complex"},
  {genie_abs_complex, "a68_abs_real_complex"},
...
TRANSLATION dyadics_nocheck[] = {
  ...
  {genie_minusab_int, "a68_min_realusab_int"},
  ...
  {genie_pow_real_int, "a68_x_up_n_real"},
  {genie_eq_real, "=="},
  {genie_ne_real, "!="},
  {genie_lt_real, "<"},
  {genie_gt_real, ">"},
  ...
  {genie_minusab_real, "a68_min_realusab_real"},
...
TRANSLATION functions_nocheck[] = {
  ...
  {genie_sindg_real, "a68_sindg_real"},
  {genie_cosdg_real, "a68_cosdg_real"},
  {genie_tandg_real, "a68_tandg_real"},
  {genie_asindg_real, "a68_asindg_real"},
  {genie_acosdg_real, "a68_acosdg_real"},
  {genie_atandg_real, "a68_atandg_real"},
  {genie_sqrt_complex, "a68_sqrt_complex"},
  {genie_exp_complex, "a68_exp_real_complex"},
  ...
  {genie_asinh_complex, "a68_asinh_real_complex"},
  {genie_acosh_complex, "a68_acosh_real_complex"},
  {genie_atanh_complex, "a68_atanh_real_complex"},
  {genie_asinh_real, "a68_asinh_real"},
  {genie_acosh_real, "a68_acosh_real"},
  {genie_atanh_real, "a68_atanh_real"},
  {genie_inverfc_real, "a68_inverfc_real"},
  {genie_inverf_real, "a68_inverf_real"},
  {NO_GPROC, NO_TEXT}
};
...
TRANSLATION constants[] = {
  ...
  {genie_int_width, "A68_INT_WIDTH"},
  {genie_long_int_width, "A68_LONG_INT_WIDTH"},
  {genie_long_mp_int_width, "A68_LONG_LONG_INT_WIDTH"},
  {genie_real_width, "A68_REAL_WIDTH"},
  {genie_long_real_width, "A68_LONG_REAL_WIDTH"},
  {genie_long_mp_real_width, "A68_LONG_LONG_REAL_WIDTH"},
  {genie_exp_width, "A68_EXP_WIDTH"},
  {genie_long_exp_width, "A68_LONG_EXP_WIDTH"},
  {genie_long_mp_exp_width, "A68_LONG_LONG_EXP_WIDTH"},
  {genie_bits_width, "A68_BITS_WIDTH"},
  {genie_bytes_width, "A68_BYTES_WIDTH"},
  {genie_long_bytes_width, "A68_LONG_BYTES_WIDTH"},
  {genie_max_abs_char, "UCHAR_MAX"},
  {genie_max_int, "A68_MAX_INT"},
  {genie_max_real, "A68_REAL_MAX"},
  {genie_min_real, "A68_REAL_MIN"},
  {genie_null_char, "NULL_CHAR"},
  {genie_small_real, "A68_REAL_EPS"},
  {genie_pi, "A68_PI"},
