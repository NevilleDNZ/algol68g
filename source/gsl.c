...
A68_ENV_REAL (genie_cgs_vacuum_permeability, GSL_CONST_CGS_VACUUM_PERMEABILITY);
A68_ENV_REAL (genie_cgs_vacuum_permittivity, GSL_CONST_CGS_VACUUM_PERMITTIVITY);
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
math_rte: math runtime error.                                                 */

static void
math_rte (NODE_T * p, BOOL_T z, MOID_T * m, const char *t)
{
  if (z)
    {
      if (t == NULL)
	{
	  diagnostic (A_RUNTIME_ERROR, p, "M math error", m, NULL);
	}
      else
	{
	  diagnostic (A_RUNTIME_ERROR, p, "M math error (gsl reports Z)", m, t);
	}
...
genie_atan2_real (NODE_T * p)
{
  ...
  if (errno != 0)
    {
      diagnostic (A_RUNTIME_ERROR, p, "arithmetic exception E");
      exit_genie (p, A_RUNTIME_ERROR);
    }
}
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC arcsinh = (REAL) REAL                                                    */

void
genie_arcsinh_real (NODE_T * p)
{
  GSL_FUNCTION (p, gsl_asinh);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC arccosh = (REAL) REAL                                                    */

void
genie_arccosh_real (NODE_T * p)
{
  GSL_FUNCTION (p, gsl_acosh);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC arctanh = (REAL) REAL                                                    */

void
genie_arctanh_real (NODE_T * p)
{
  GSL_FUNCTION (p, gsl_atanh);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC csqrt = (COMPLEX) COMPLEX                                                */

void
genie_sqrt_complex (NODE_T * p)
{
  GSL_COMPLEX_FUNCTION (gsl_complex_sqrt);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC cexp = (COMPLEX) COMPLEX                                                 */

void
genie_exp_complex (NODE_T * p)
{
  GSL_COMPLEX_FUNCTION (gsl_complex_exp);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC cln = (COMPLEX) COMPLEX                                                  */

void
genie_ln_complex (NODE_T * p)
{
  GSL_COMPLEX_FUNCTION (gsl_complex_log);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC csin = (COMPLEX) COMPLEX                                                 */

void
genie_sin_complex (NODE_T * p)
{
  GSL_COMPLEX_FUNCTION (gsl_complex_sin);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC ccos = (COMPLEX) COMPLEX                                                 */

void
genie_cos_complex (NODE_T * p)
{
  GSL_COMPLEX_FUNCTION (gsl_complex_cos);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC ctan = (COMPLEX) COMPLEX                                                 */

void
genie_tan_complex (NODE_T * p)
{
  GSL_COMPLEX_FUNCTION (gsl_complex_tan);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC carcsin = (COMPLEX) COMPLEX                                              */

void
genie_arcsin_complex (NODE_T * p)
{
  GSL_COMPLEX_FUNCTION (gsl_complex_arcsin);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC carccos = (COMPLEX) COMPLEX                                              */

void
genie_arccos_complex (NODE_T * p)
{
  GSL_COMPLEX_FUNCTION (gsl_complex_arccos);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC carctan = (COMPLEX) COMPLEX                                              */

void
genie_arctan_complex (NODE_T * p)
{
  GSL_COMPLEX_FUNCTION (gsl_complex_arctan);
}

/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC csinh = (COMPLEX) COMPLEX                                                */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC gamma incomplete = (REAL, REAL) REAL                                     */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC beta incomplete = (REAL, REAL, REAL) REAL                                */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC airy ai derivative = (REAL) REAL                                         */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC airy bi derivative = (REAL) REAL                                         */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel exp in = (REAL, REAL) REAL                                        */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel exp kn = (REAL, REAL) REAL                                        */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel exp il = (REAL, REAL) REAL                                        */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel exp kl = (REAL, REAL) REAL                                        */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel jnu = (REAL, REAL) REAL                                           */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel ynu = (REAL, REAL) REAL                                           */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel inu = (REAL, REAL) REAL                                           */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel exp inu = (REAL, REAL) REAL                                       */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel knu = (REAL, REAL) REAL                                           */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC bessel exp knu = (REAL, REAL) REAL                                       */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC elliptic integral k = (REAL) REAL                                        */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC elliptic integral e = (REAL) REAL                                        */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC elliptic integral rf = (REAL, REAL, REAL) REAL                           */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC elliptic integral rd = (REAL, REAL, REAL) REAL                           */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC elliptic integral rj = (REAL, REAL, REAL, REAL) REAL                     */
...
/*-------1---------2---------3---------4---------5---------6---------7---------+
PROC elliptic integral rc = (REAL, REAL) REAL                                 */
